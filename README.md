...
<br> An API based on the 1995 movie "Hackers". One day, I built this to get a more intimate feel for building a RESTful API (which I absolutely love doing now) and how to containerize an app (which I'm admittedly still a bit fuzzy on). Get information on characters, organizations, hacks, quotes, and more. Inspired by the continued maintenance of Cyberdelia NYC and Hackers Curator by fellow fans. Hack the planet!
